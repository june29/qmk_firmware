 ...
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | Ctl/Esc|   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |; / L1|   L2   |
 * |--------+------+------+------+------+------| Left |           | Rght |------+------+------+------+------+--------|
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        LT(SYMB,KC_GRV),MO(MDIA),     LALT(KC_LSFT),  KC_LALT,KC_LCMD,
                                              ALT_T(KC_APP),  KC_LGUI,
                                                              KC_HOME,
                                               KC_SPC,KC_BSPC,SGUI(KC_LBRC),
        // right hand
             ...
             KC_RGHT,      KC_N,   KC_M,   KC_COMM,KC_DOT, CTL_T(KC_SLSH),   KC_RSFT,
                                   KC_RCMD,KC_LALT,KC_LBRC,KC_RBRC,          KC_FN1,
             KC_LALT,      CTL_T(KC_ESC),
             KC_PGUP,
             SGUI(KC_RBRC),KC_TAB, KC_ENT
    ),
