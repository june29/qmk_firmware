 ...
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |  Ctrl  |   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |; / L1|   L2   |
 * |--------+------+------+------+------+------| Left |           | Rght |------+------+------+------+------+--------|
 * | LShift |Z/Ctrl|   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |   .  |//Ctrl| RShift |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |  L1  |  L2  |AltShf|  Alt |  Cmd |                                       |  Cmd | Alt  |   [  |   ]  | ~L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | App  | LGui |       | Alt  |Ctrl/Esc|
 *                                 ,------|------|------|       |------+--------+------.
 *                                 |      |      | Home |       | PgUp |        |      |
 *                                 | Space| PTab |------|       |------|  NTab  |Enter |
 *                                 |      |      | Esc  |       | Del  |        |      |
 *                                 `--------------------'       `----------------------'
 */
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        MO(SYMB),       MO(MDIA),     LALT(KC_LSFT),  KC_LALT,KC_LCMD,
                                              ALT_T(KC_APP),  KC_LGUI,
                                                              KC_HOME,
                                               KC_SPC,SCMD(KC_LBRC),KC_ESC,
        // right hand
             ...
             KC_RGHT,      KC_N,   KC_M,   KC_COMM,KC_DOT, CTL_T(KC_SLSH),   KC_RSFT,
                                   KC_RCMD,KC_LALT,KC_LBRC,KC_RBRC,          MO(SYMB),
             KC_LALT,      CTL_T(KC_ESC),
             KC_PGUP,
             KC_BSPC,      SCMD(KC_RBRC), KC_ENT
    ),
